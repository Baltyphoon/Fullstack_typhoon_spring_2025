...
#special characters
special_char = "New line: \n\tTabulator"
print(special_char)

#raw string
special_char = r"New line: \n\tTabulator"
print(special_char)
...
name = "Бат"
age = 25
print("Сайн уу, %s! Таны нас %d." % (name, age)) # Сайн уу, Бат! Таны нас
25.
# format() арга ашиглах
print("Сайн уу, {}! Таны нас {}.".format(name, age)) # Сайн уу, Бат! Танынас 25.
print("Сайн уу, {0}! Таны нас {1}.".format(name, age)) # Сайн уу, Бат!Таны нас 25.
print("Сайн уу, {name}! Таны нас {age}.".format(name=name, age=age)) #Сайн уу, Бат! Таны нас 25.

# f-string ашиглах (Python 3.6+)
print(f"Сайн уу, {name}! Таны нас {age}.") # Сайн уу, Бат! Таны нас 25.
print(f"Таны 5 жилийн дараах нас: {age + 5}") # Таны 5 жилийн дараах нас:30
