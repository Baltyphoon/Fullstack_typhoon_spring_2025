...
tuple2 = 1, 2, 3, 4, 5  # tuples without brcket 
tuple3 = (1,) # only one element tuple
empty_tuple = () # empty tuple
mixed_tuple = (1, "hoyr", 3.0, True) # multi type tuples
...
# Element uurchluh - aldaa gargana 
...
#del tuple1[0]  # TypeError: 'tuple' object doesn't support item deletion to change the tuple
